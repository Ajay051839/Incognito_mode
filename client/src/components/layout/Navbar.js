...
const Navbar = ({ auth: { isAuthenticated, loading, user }, logout }) => {
  ...
  return (
    // <nav className='navbar flex h-25 bg-gray-800'>
    //   <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-2">
    //   <h1>
    //     <Link to='/dashboard'>
    //       <i className='mx-0 fas fa-code not-italic text-white  py-0.5 rounded-md text-lg font-medium'>Shinchan Movie Hunt</i>
    //     </Link>
    //   </h1>
    //   <div>
    //   {!loading && (
    //    <span><Fragment>{isAuthenticated ? authLinks : guestLinks}</Fragment></span>
    //   )}
    //   </div>
    //   </div>
